     ...
     // var url = 'https://secureapp.trenditapp.com/trendit/trendit-api/u/A0007';
        jQuery.ajax({
            ...
            success: function(data) {
            	...
            	var phone = data.user_phone_number;
            	var user_url = 'https://trendit.app.link/profile/'+userId;
            	if(user_type == 'p'){
            		bookinghtml = '<button class="btn btn-book"><a href="'+user_url+'"><img src="images/cal_icon.png"> Book Appointment</a></button><a href="tel:'+phone+'"><img src="https://trenditapp.com/profile/images/call.jpg"/></a>';
            	...
            	var myHtml ='';
            	if(!profile_image){
            	    profile_image = 'https://trenditapp.com/assets/images/logo.png';
            	}
            	
            	myHtml+='<section class="profile_section"><div class="container"><div class="profile_header"><div class="prof-image"><img src="'+profile_image+'"></div></div><div class="prof_info text-center"><h2><a href="'+user_url+'">'+user_name+'</a></h2><div class="prof_id">TID: '+tid+'</div><div class="profile">'+st_type_name+'</div>'+bookinghtml+'</div></div></section>';    
				    ...
				    if(post_type =='style'){	 
    					...
    					myHtml+='<div class="text-center mr-auto">';
    					 if(post.user_type_creator == 'p'){
    					     if(creator){
    						 myHtml+='<div class="provider"><a href="'+app_link+'">'+creator+'<a></div><div class="text-red">Provider</div>';
    					     }
    					 }else{
    					     if(creator){
    						 myHtml+='<div class="customer"><a href="'+app_link+'">'+creator+'</a></div><div class="text-gray">Client</div>';
    					     }
    					 }
    					 myHtml+='</div>';
    					 if(price){
