...
$toemails[] = array(
				'email' => 'mailer@trenditapp.com', // Your Email Address
				'name' => 'Form Response' // Your Name
			);
...
$fromemail = array(
				'email' => 'webrequest@trenditapp.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Trendit Website Form' // Company Name
			);
